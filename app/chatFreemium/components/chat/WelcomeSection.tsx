  ...
  return (
    <div className="flex-1 flex flex-col justify-center items-center">
      <div className="w-full flex flex-col items-center max-w-[600px]">
        <h1 className='flex text-[32px] font-[300] leading-[17.52px] mb-4 gap-2'>
          <span className="font-[800]">Hey </span>
          {userName}, how can I help you today?
        </h1>
        <div className='text-center text-[14px] text-white/90 font-[400] leading-[150%] mt-6'>
          ...
          <p className='flex flex-col items-center justify-center pt-6'>
