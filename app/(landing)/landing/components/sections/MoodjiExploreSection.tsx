...
interface MoodjiExploreSectionProps {
  headingColor?: string; 
}
const MoodjiExploreSection: React.FC<MoodjiExploreSectionProps> = ({ headingColor = '#984A2E'}) => {
  return (
    <section className="flex flex-col items-center py-16 px-4 text-center" aria-labelledby="explore-heading">
      <header className="mb-12">
        <h2 
          id="explore-heading"
          className="text-2xl sm:text-3xl lg:text-[45px] font-medium leading-tight tracking-wide mb-3"
