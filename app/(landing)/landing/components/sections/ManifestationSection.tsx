...
interface ManifestationSectionProps {
  headingColor?: string;
  buttonBg?: string; // additional className for button bg override
}

const ManifestationSection: React.FC<ManifestationSectionProps> = ({
  headingColor = '#984A2E',
  buttonBg = '',
}) => {
  const chatMessages = [
    ...
    <section className="flex flex-col items-center mb-20">
      <div className="flex flex-col items-center justify-center w-full pt-24">
        ...
        <div className="flex flex-col items-center justify-center w-full text-center gap-3 mb-14 px-4">
          <h2
            className="text-2xl sm:text-3xl lg:text-[45px] leading-[120%] tracking-[0.41px] font-medium"
        ...
        <div className="flex justify-center w-full max-w-6xl mx-4">
          <div className="w-full max-w-[95%] lg:h-[700px] h-full bg-white/60 backdrop-blur-[40px] border-[2.44px] border-white/20 rounded-[20px] p-8">
