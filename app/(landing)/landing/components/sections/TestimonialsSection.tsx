...
const TestimonialsSection: React.FC<TestimonialsSectionProps> = ({ headingColor = '#984A2E' }) => {
  const testimonials = [
    {
  ...
  return (
    <section className="flex flex-col items-center justify-center w-full py-16">
      ...
      <div className="flex flex-wrap lg:flex-nowrap items-center justify-center gap-5 px-4 w-full">
