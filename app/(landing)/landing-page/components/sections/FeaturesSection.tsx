...
const FeaturesSection: React.FC = () => {
  ...
  return (
    <section className="w-full">
      ...
      >
        {/* Header */}
        <div className="flex flex-col items-center justify-center pt-12 px-4 bg-gradient-to-b from-white to-transparent">
        ...
        <div className="flex flex-col items-center justify-center mt-20 px-4">
          <Image
            ...
            className="mx-auto"
          />
          <h2 className="text-2xl sm:text-3xl lg:text-[45px] font-normal leading-[120%] text-[#984A2E] tracking-[0.41px] mt-4">
